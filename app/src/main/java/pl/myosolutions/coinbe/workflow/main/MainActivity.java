...
import pl.myosolutions.coinbe.databinding.ActivityMainBinding;
import pl.myosolutions.coinbe.model.ExchangeItem;
import pl.myosolutions.coinbe.workflow.IActivityTransitions;
import pl.myosolutions.coinbe.workflow.details.DetialsActivity;
import pl.myosolutions.coinbe.workflow.main.list.ExchangeAdapter;

import static pl.myosolutions.coinbe.workflow.IActivityKeys.CURRENT_LIST_TOTAL_KEY;
import static pl.myosolutions.coinbe.workflow.IActivityKeys.CURRENT_MARKET_KEY;
import static pl.myosolutions.coinbe.workflow.main.list.IExchangeValues.Currencies.BTC;
import static pl.myosolutions.coinbe.workflow.main.list.IExchangeValues.Currencies.EUR;
import static pl.myosolutions.coinbe.workflow.main.list.IExchangeValues.Currencies.PLN;
import static pl.myosolutions.coinbe.workflow.main.list.IExchangeValues.Currencies.USD;
